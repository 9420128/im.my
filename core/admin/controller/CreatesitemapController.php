...
class CreatesitemapController extends BaseAdmin
{
    ...
    protected $fileArr = ['jpg', 'pnp', 'jpeg', 'gif', 'xls', 'xlsx', 'pdf', 'mp4', 'mpeg', 'mp3'];
    protected $filterArr = [
        'url' => ['mailto'],
        'get' => []
    ];
    ...
    public function inputData($links_counter = 1, $redirect = true){
        ...
        if(!$this->checkParsingTable()){
            ...
            $this->cancel(0, 'You have problem with database parsing_data', '', true);
        ...
        if($redirect){
            ...
            !$_SESSION['res']['answer'] && $_SESSION['res']['answer'] = '<div class="success">Карта сайта создана</div>';
    ...
    // 61, 70 Создает в базе данных вспомогательную таблицу если ее нет, для хранения данных при сканировании
